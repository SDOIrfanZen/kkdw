        ...
        <div class="card-body">
            <form method="post" action="{{ route('administration.pengguna_approval_process', $userProfile->id) }}" id="" class="m-3">
                ...
                <div class="row pb-2">
                    ...
                    <div class="col-md-3">
                        <input readonly class="form-control" name="kad_pengenalan" value="{{ substr($userProfile->kad_pengenalan, 0, 6) . '-' . substr($userProfile->kad_pengenalan, 6, 2) . '-' . substr($userProfile->kad_pengenalan, 8) }}">
                    </div>                    
