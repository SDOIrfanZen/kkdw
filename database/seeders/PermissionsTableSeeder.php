...
class PermissionsTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('permissions')->insert([
            ...
            ['id' => 14, 'name' => 'Purata Nasional, Unjuran, NOC, Baucar', 'guard_name' => 'web', 'created_at' => null, 'updated_at' => null],
            ['id' => 15, 'name' => 'Dashboard Utama', 'guard_name' => 'web', 'created_at' => null, 'updated_at' => null],
            ['id' => 16, 'name' => 'Dashboard Menteri', 'guard_name' => 'web', 'created_at' => null, 'updated_at' => null],
            ['id' => 17, 'name' => 'Dashboard Infrastruktur Asas & Laporan', 'guard_name' => 'web', 'created_at' => null, 'updated_at' => null],
            ['id' => 18, 'name' => 'Dashboard Ekonomi & Laporan', 'guard_name' => 'web', 'created_at' => null, 'updated_at' => null],
            ['id' => 19, 'name' => 'Dashboard Modal Insan & Laporan', 'guard_name' => 'web', 'created_at' => null, 'updated_at' => null],
            ['id' => 20, 'name' => 'Dashboard Usahawan', 'guard_name' => 'web', 'created_at' => null, 'updated_at' => null],
            ['id' => 21, 'name' => 'Dashboard Profil Kampung', 'guard_name' => 'web', 'created_at' => null, 'updated_at' => null],
            ['id' => 22, 'name' => 'Papar Maklumat Profil Pengguna', 'guard_name' => 'web', 'created_at' => null, 'updated_at' => null],
            ['id' => 23, 'name' => 'Kemaskini Maklumat Pengguna (data semasa daftar akaun)', 'guard_name' => 'web', 'created_at' => null, 'updated_at' => null],
            ['id' => 24, 'name' => 'Tukar Kata Laluan', 'guard_name' => 'web', 'created_at' => null, 'updated_at' => null],
            ['id' => 25, 'name' => 'Papar Senarai Log', 'guard_name' => 'web', 'created_at' => null, 'updated_at' => null],
            ['id' => 26, 'name' => 'Carian Log (hari atau pengguna)', 'guard_name' => 'web', 'created_at' => null, 'updated_at' => null],
            ['id' => 27, 'name' => 'Export Excel/PDF', 'guard_name' => 'web', 'created_at' => null, 'updated_at' => null],
            ['id' => 28, 'name' => 'Prestasi Perbelanjaan Negeri', 'guard_name' => 'web', 'created_at' => null, 'updated_at' => null],
